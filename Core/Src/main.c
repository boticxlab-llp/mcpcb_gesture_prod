...
#define LED_HIGH HAL_GPIO_WritePin(GPIOB, GPIO_PIN_11, GPIO_PIN_RESET)
#define LED_LOW HAL_GPIO_WritePin(GPIOB, GPIO_PIN_11, GPIO_PIN_SET)
  /* USER CODE END 2 */
...
//				  		  	HAL_Delay(1000);
//		  			HAL_GPIO_WritePin(GPIOA, GPIO_PIN_led1, 0);
//		  			  	HAL_Delay(1000);
  }
  /* USER CODE END 3 */
}
